...
const translations = {
  es: {
    ...
    'hero.cta1': 'Solicitar asesoría técnica',
    ...
    'idx.cert.tit': 'Estándares internacionales de operación.',
    ...
    'idx.s4.num': 'Especialización técnica',
    'idx.stat.proj': 'Proyectos Ejecutados',
    'idx.s4.tit': 'Estructuras, obra civil y soluciones industriales',
    'idx.s4.p': 'Diseño y ejecución bajo los más altos estándares técnicos de la industria.',
    ...
    'idx.why.tagline': 'La ingeniería sin compromiso es la única que funciona.',
    'idx.why.1t': 'Despliegue Responsivo',
    'idx.why.1p': 'Capacidad técnica e insumos listos para despliegue rápido. Escalamos recursos humanos y materiales frente a necesidades críticas de cronograma o contingencias.',
    'idx.why.2t': 'Calidad con Tolerancia Cero',
    'idx.why.2p': 'No utilizamos subcontratistas genéricos. Inspeccionamos soldadura, cimentación y conductos con técnicas avanzadas y validación certificada de terceros.',
    ...
    'idx.cc.sub': 'Infraestructura estratégica, mantenimiento especializado y soluciones llave en mano. Explore nuestras divisiones principales soportadas por un equipo de alto rendimiento técnico.',
    ...
    'idx.cta.tit': 'Comienza una evaluación técnica interactiva.',
    'idx.cta.p': 'Comparte requerimientos críticos a través de nuestro portal y un ingeniero senior atenderá tu caso en menos de 24 horas.',

    // ── Contacto (Home) ──────────────────────────────────────
    'idx.contact.eyebrow': 'Inicia un Proyecto',
    'idx.contact.tit': 'Hablemos de tu proyecto.',
    'idx.contact.sub': 'Envía tus especificaciones. Un ingeniero especializado revisará los requerimientos y te contactará en menos de 24 horas.',
    ...
    'idx.foot.pwr': 'Con el respaldo de Arquitectura Estructural Avanzada.',
    'idx.footer.bio': 'Ingeniería industrial de precisión, desarrollo de infraestructura crítica y mantenimiento técnico para sectores de alta exigencia operativa y tolerancia cero a fallos.',
    'idx.footer.nav_title': 'Corporativo',
    'idx.footer.norms_title': 'Normatividad',
    'idx.footer.contact_title': 'Contacto Central',

    // ── Servicios ────────────────────────────────────────────
    'srv.page.title': 'Catálogo de Soluciones Técnicas',
    ...
    'srv.c1.text': 'Desarrollo de proyectos industriales y civiles llave en mano, aplicando estándares internacionales para garantizar calidad, seguridad y eficiencia en cada obra.',
    'srv.c1.l1': 'Procesos llave en mano completos (EPC)',
    'srv.c1.l2': 'Modelado BIM y diseño estructural avanzado',
    'srv.c1.l3': 'Garantías técnicas de cumplimiento en cronogramas',
    ...
    'srv.c3.l3': 'Hot-tapping técnico en líneas operativas',
    'srv.c4.title': 'Suministro Industrial',
    'srv.c4.text': 'Gestión técnica de refacciones con acceso a una red global de manufactura certificada, reduciendo la fricción logística en sus plantas.',
    ...
    'srv.cta.sub': 'Nuestro catálogo incluye más especialidades focalizadas. Converse directamente con un Ingeniero en Planta para analizar sus requerimientos.',
    'srv.cta.btn': 'Solicitar Evaluación Técnica',
    'srv.cta.tag': 'siguiente paso',
    'srv.stats.div': 'Divisiones Técnicas',
    ...
    'abt.page.sub': 'Excelencia técnica y ejecución comprometida para cada desafío estructural.',
    'abt.hero.eyebrow': 'Proatam',
    'abt.hero.sub': 'Construcción y mantenimiento con enfoque técnico de alta exigencia.',
    'abt.badge': 'Nuestra identidad',
    'abt.p1': 'Somos una empresa constructora dinámica, conformada por profesionales altamente capacitados y comprometidos con la ejecución eficiente, segura y técnica de cada proyecto.',
    ...
    'abt.p3': 'Cada proyecto se ejecuta bajo estrictas normativas nacionales e internacionales, garantizando un proceso profesional desde la planificación hasta la entrega final.',
    'abt.stat1.lbl': 'Años',
    ...
    'abt.mission.text': 'Brindar servicios especializados de construcción y mantenimiento para la industria petrolera, garantizando seguridad, calidad, eficiencia operativa y cumplimiento normativo, generando valor sostenible para nuestros clientes, comunidades y colaboradores.',
    'abt.vision.text': 'Ser reconocidos como la empresa líder en soluciones integrales de construcción y mantenimiento para el sector energético en México, destacando por nuestra excelencia técnica, innovación, compromiso con la seguridad y respeto al medio ambiente.',
    ...
    'abt.cta.sub': 'Un ingeniero senior revisará tus requerimientos y te contactará en menos de 24 horas hábiles.',
    'abt.cta.btn': 'Contactar al Departamento Técnico',
    ...
    'faq.a3': 'Sí, tenemos la capacidad técnica y humana para ejecutar proyectos de principio a fin.',
    ...
    'faq.a8': 'Sí, contamos con la capacidad técnica, operativa y administrativa para escalar recursos humanos, materiales y de equipo en caso de que el proyecto requiera acelerar su ejecución por cambios en el programa, necesidades del cliente o eventos imprevistos.',
    ...
    'faq.a11': 'A través de protocolos técnicos, administrativos y de supervisión que aseguren que lo ejecutado cumple con planos, especificaciones y normativas aplicables.',
    ...
    'faq.a15': 'Una vez concluida y entregada la obra, ofrecemos servicios de atención postventa para asegurar la satisfacción del cliente y el correcto funcionamiento de lo construido. Nuestro procedimiento incluye: Atención a reportes post-entrega, Evaluación técnica y programación, Ejecución de trabajos correctivos o de mantenimiento, Cierre y validación del servicio, y Compromiso de respuesta oportuna.',
    'faq.cta.tit': '¿Tienes alguna otra consulta?',
    'faq.cta.btn': 'Contactar al Departamento Técnico',
    'faq.unclear.tit': '¿No encuentras lo que buscas?',
    'faq.unclear.sub': 'Contacta directamente',
    'faq.cta.tag': 'siguiente paso',
    'faq.cta.p': 'Habla directamente con un ingeniero especializado. Respuesta en menos de 24 horas.',

    // ── Contacto (página) ────────────────────────────────────
    'cnt.badge': 'Evaluación Técnica de Proyectos',
    'cnt.page.title': 'Contacto Técnico',
    'cnt.title': 'Contáctenos.',
    'cnt.sub': 'Envíe sus especificaciones. Un ingeniero especializado revisará los requerimientos y agendará una sesión de consultoría.',
    ...
    'cnt.frm.btn': 'Enviar Solicitud Técnica',
    'cnt.frm.privacy': 'Tu información es confidencial y no será compartida con terceros.',
    'cnt.frm.sub': 'Complete el formulario y un ingeniero lo contactará en menos de 24 hrs.',
    ...
    'modal.sub': 'Hemos recibido tu solicitud correctamente.<br/>Un ingeniero senior se pondrá en contacto contigo en menos de 24 horas hábiles.',
    'modal.immediate': '¿Necesitas atención inmediata?',
    'modal.ok': 'Entendido',
    'whatsapp.cta': 'Contactar por WhatsApp',
    'whatsapp.label': 'WhatsApp Corporativo',
  ...
  en: {
    ...
    'hero.cta1': 'Request technical advice',
    ...
    'idx.s4.num': 'Technical specialization',
    'idx.stat.proj': 'Projects Executed',
    'idx.s4.tit': 'Structures, civil works and industrial solutions',
    'idx.s4.p': 'Design and execution under the highest technical standards of the industry.',
    ...
    'idx.why.tagline': 'Engineering without compromise is the only one that works.',
    'idx.why.1t': 'Responsive Deployment',
    'idx.why.1p': 'Technical capacity and supplies ready for rapid deployment. We scale human and material resources against critical schedule needs or contingencies.',
    'idx.why.2t': 'Zero Tolerance Quality',
    'idx.why.2p': 'We do not use generic subcontractors. We inspect welding, foundations and conduits with advanced techniques and certified third-party validation.',
    ...
    'idx.cc.sub': 'Strategic infrastructure, specialized maintenance and turnkey solutions. Explore our main divisions supported by a high-performance technical team.',
    ...
    'idx.cta.tit': 'Start an interactive technical evaluation.',
    'idx.cta.p': 'Share critical requirements through our portal and a senior engineer will attend to your case in less than 24 hours.',

    // ── Contacto (Home) ──────────────────────────────────────
    'idx.contact.eyebrow': 'Start a Project',
    'idx.contact.tit': "Let's talk about your project.",
    'idx.contact.sub': 'Submit your specifications. A specialized engineer will review the requirements and contact you within 24 hours.',
    ...
    'idx.foot.pwr': 'Backed by Advanced Structural Architecture.',
    'idx.footer.bio': 'Precision industrial engineering, development of critical infrastructure and technical maintenance for sectors with high operational demand and zero tolerance for failure.',
    'idx.footer.nav_title': 'Corporate',
    'idx.footer.norms_title': 'Regulatory Compliance',
    'idx.footer.contact_title': 'Central Contact',

    // ── Servicios ────────────────────────────────────────────
    'srv.page.title': 'Technical Solutions Catalog',
    ...
    'srv.c1.l3': 'Technical guarantees of schedule compliance',
    ...
    'srv.c3.l3': 'Technical hot-tapping in operational lines',
    'srv.c4.title': 'Industrial Supply',
    'srv.c4.text': 'Technical management of spare parts with access to a global network of certified manufacturing, reducing logistical friction in your plants.',
    ...
    'srv.cta.sub': 'Our catalog includes more focused specialties. Speak directly with a Plant Engineer to analyze your requirements.',
    'srv.cta.btn': 'Request Technical Evaluation',
    'srv.cta.tag': 'next step',
    'srv.stats.div': 'Technical Divisions',
    ...
    'abt.page.sub': 'Technical excellence and committed execution for every structural challenge.',
    'abt.hero.eyebrow': 'Proatam',
    'abt.hero.sub': 'Construction and maintenance with a high-demand technical focus.',
    'abt.badge': 'Our identity',
    'abt.p1': 'We are a dynamic construction company, made up of highly trained professionals committed to the efficient, safe and technical execution of every project.',
    ...
    'abt.mission.text': 'Provide specialized construction and maintenance services for the oil industry, guaranteeing safety, quality, operational efficiency and regulatory compliance, generating sustainable value for our clients, communities and collaborators.',
    'abt.vision.text': 'To be recognized as the leading company in integral construction and maintenance solutions for the energy sector in Mexico, standing out for our technical excellence, innovation, commitment to safety and respect for the environment.',
    ...
    'abt.cta.sub': 'A senior engineer will review your requirements and contact you in less than 24 business hours.',
    'abt.cta.btn': 'Contact the Technical Department',
    ...
    'faq.a3': 'Yes, we have the technical and human capacity to execute projects from start to finish.',
    ...
    'faq.a8': 'Yes, we have the technical, operational and administrative capacity to scale human, material and equipment resources if the project requires accelerating its execution due to schedule changes, client needs or unforeseen events.',
    ...
    'faq.a11': 'Through technical, administrative and supervision protocols that ensure that what is executed complies with plans, specifications and applicable regulations.',
    ...
    'faq.a15': 'Once the work is completed and delivered, we offer after-sales services to ensure customer satisfaction and correct functioning of what was built. Our procedure includes: Response to post-delivery reports, Technical evaluation and scheduling, Execution of corrective or maintenance work, Service closure and validation, and Commitment to timely response.',
    'faq.cta.tit': 'Have more questions?',
    'faq.cta.btn': 'Contact Our Technical Department',
    'faq.unclear.tit': "Can't find what you're looking for?",
    'faq.unclear.sub': 'Contact us directly',
    'faq.cta.tag': 'next step',
    'faq.cta.p': 'Speak directly with a specialized engineer. Response in less than 24 hours.',

    // ── Contacto (página) ────────────────────────────────────
    'cnt.badge': 'Technical Project Assessment',
    'cnt.page.title': 'Technical Contact',
    'cnt.title': 'Contact Us.',
    'cnt.sub': 'Submit your specifications. A specialized engineer will review your requirements and schedule a consulting session.',
    ...
    'cnt.frm.btn': 'Submit Technical Inquiry',
    'cnt.frm.privacy': 'Your information is confidential and will never be shared with third parties.',
    'cnt.frm.sub': 'Complete the form and an engineer will contact you in less than 24 hours.',
    ...
    'modal.sub': 'We have successfully received your request.<br/>A senior engineer will contact you in less than 24 business hours.',
    'modal.immediate': 'Need immediate attention?',
    'modal.ok': 'Got it',
    'whatsapp.cta': 'Contact via WhatsApp',
    'whatsapp.label': 'Corporate WhatsApp',
